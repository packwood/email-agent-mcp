...
export async function buildLazyActions(
  ...
  return [
    ...
    wrapAction(createForwardDraftAction),
    wrapAction(findDraftByTrackingIdAction),
    wrapAction(inspectDraftExactAction),
    wrapAction(sendDraftAction),
    wrapAction(updateDraftAction),
    wrapAction(addDraftAttachmentsAction),
    wrapAction(removeDraftAttachmentsAction),
